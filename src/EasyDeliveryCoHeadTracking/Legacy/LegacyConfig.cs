...
namespace EasyDeliveryCoHeadTracking.Legacy
{
    ...
    /// BepInEx\config\com.cameraunlock.easydeliveryco.headtracking.cfg, with their defaults. Frozen:
    /// a later change to the runtime settings or to core's constants must never change what an old
