@echo off
:: ============================================
:: Easy Delivery Co Head Tracking - Uninstall
:: ============================================
...
set "PRESERVE_FILES=BepInEx\config\CameraUnlock.ini BepInEx\config\com.cameraunlock.easydeliveryco.headtracking.cfg"
