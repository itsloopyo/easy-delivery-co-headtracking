...
:: Match the exact key:value pair so unrelated fields containing the word
:: "true" (e.g. a future "verified": true) can't false-positive this check.
set "WE_INSTALLED=false"
if exist "%GAME_PATH%\%STATE_FILE%" (
    findstr /c:"\"installed_by_us\": true" "%GAME_PATH%\%STATE_FILE%" >nul 2>&1
