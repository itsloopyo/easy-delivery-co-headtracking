...
$null = & "$projectDir/cameraunlock-core/scripts/package-bepinex-mod.ps1" `
    -ModName $modName `
...
# with the binaries in both ZIPs. The shared script stages it into the installer
# ZIP; the Nexus ZIP below is built here and stages it itself.
